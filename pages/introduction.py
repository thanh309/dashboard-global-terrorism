...
layout = html.Div([
    html.Img(src='/assets/terrorism.jpg', style={'width': '100%', 'display':'block','margin': 'auto'}),
    dbc.Card(
        dbc.CardBody(
            [
        ...
        style={"background-color": "#282c34", "color": "white", 'width': '100%','margin': 'auto'}
    )
])